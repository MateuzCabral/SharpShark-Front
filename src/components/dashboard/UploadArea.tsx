      ...
      <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Monitoramento de Pasta (Hot Folder)
          </CardTitle>
          <CardDescription>
            Monitore uma pasta e analise automaticamente novos arquivos
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="folder-select">Selecionar Pasta</Label>
            <div className="flex gap-2">
              <Input
                id="folder-select"
                ref={folderInputRef}
            ...
            {monitoringPath && (
              <p className="text-sm text-muted-foreground">
                Pasta: <span className="font-medium">{monitoringPath}</span>
              </p>
            )}
          </div>
          ...
          <div className="flex items-center gap-3 p-4 rounded-lg border border-border/50 bg-muted/20">
            <div className="flex-1">
              <p className="font-medium text-sm">Status do Monitoramento</p>
              <p className="text-xs text-muted-foreground">
                {isMonitoring
                  ? `Monitorando ativamente: ${monitoringPath}`
